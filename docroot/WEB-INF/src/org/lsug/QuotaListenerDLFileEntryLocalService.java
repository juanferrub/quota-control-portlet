...
public class QuotaListenerDLFileEntryLocalService 
	...
	public DLFileEntry updateFileEntry(
			...
			long fileEntryTypeId, Map<String, Fields>fieldsMap, File file, InputStream is, 
		...
		DLFileEntry dlFileEntry = super.updateFileEntry(userId, fileEntryId, sourceFileName, 
				mimeType, title, description, changeLog, majorVersion, fileEntryTypeId, 
